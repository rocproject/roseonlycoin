...
<<<<<<< HEAD
const QString BITCOIN_IPC_PREFIX("roseonlycoin:");
=======
const QString BITCOIN_IPC_PREFIX("hirocoin:");
...
<<<<<<< HEAD
        qDebug() << tr("Cannot start roseonlycoin: click-to-pay handler");
=======
        qDebug() << tr("Cannot start hirocoin: click-to-pay handler");
>>>>>>> 4e4ef7e73515f26174f9ca9d15fdcb46b1890589
    else
