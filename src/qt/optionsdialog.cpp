...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
<<<<<<< HEAD
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting RoseOnlycoin."), QMessageBox::Ok);
=======
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Hirocoin."), QMessageBox::Ok);
